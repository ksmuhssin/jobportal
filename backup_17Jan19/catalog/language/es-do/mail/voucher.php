<?php
// Text
$_['text_subject']  = 'Le han enviado un certificado de regalo de %s';
$_['text_greeting'] = 'Felicidades, has recibido un vale de regalo %s';
$_['text_from']     = 'Este certificado de regalo le ha sido enviado por %s';
$_['text_message']  = 'Con un mensaje que dice';
$_['text_redeem']   = 'Para canjear este Certificado de regalo, escriba el código de canje que es <b>%s</b> luego haga clic en el enlace a continuación y compre el producto en el que desea usar este certificado de regalo. Puede ingresar el código del certificado de regalo en la página del carrito de compras antes de hacer clic en Finalizar compra.';
