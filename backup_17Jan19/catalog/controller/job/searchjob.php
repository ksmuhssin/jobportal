<?php
class ControllerJobSearchJob extends Controller {
	private $error = array();
	public function index() {
		$this->load->language('job/searchjob');
        ...
        $data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('job/searchjob')
		);
		...
		$pagination->url = $this->url->link('job/searchjob', '&page={page}');
		...
		$this->response->setOutput($this->load->view('job/searchjob', $data));
	}
