...
<?php if($tmdblogsetting_blogarticleimg){ ?>
            <div class="image listimg"><a href="<?php echo $href?>"><img src="<?php echo $thumb?>" alt="<?php echo $thumb?>" title="<?php echo $thumb?>" class="img-responsive" /></a>
            
	<div class="col-sm-12 padd">
	<div class=" headtitle">
		<div class="col-sm-2 inner pull-left col-xs-12">
			<img src="catalog/view/theme/jobportal/image/userimg.png"/>
  ...
  <div class="row"><?php echo $column_left; ?>
    <?php if ($column_left && $blog_right) { ?>
    <?php $class = 'col-sm-6'; ?>
    <?php } elseif ($column_left || $blog_right) { ?>
	  ...
	  <div class="row all">
		<div class="product-layout product-list col-xs-12">
			<div class="product-thumb">
				...
				<?php if($tmdblogsetting_blogdescp){ ?><div class="description pull-left"><?php echo $description ?></div><?php } ?>
		...
		<div class="commentbox2 adddata">
				<div class="userpic"><img src="catalog/view/theme/jobportal/image/user_img.png"/></div>
				<div class="inputbox">
			 ...
			 <div class="lognhead"><?php echo $text_belogin; ?> </div>
				...
				<div class="col-sm-12">
					...
					<div class="pull-right forgot">
						<a href="index.php?route=account/forgotten"><?php echo $text_forgot; ?></a>
					</div>
				</div>
			</div>
			</div>
		...
		<?php } ?>-->
			...
			<div class="commentbox pull-left col-sm-12 post">
				...
				<div id="button-upload"><img src="catalog/view/theme/jobportal/image/user_img.png"/></div>
				</div>
...
$('.addbuton').bind('click', function() {
	...
	$('.alert, .text-danger').remove();
		...
		if (json['error']) {
			...
			if(json['error']){
			$('.commnt-success').after('<div class="alert alert-danger"><i class="fa fa-exclamation-circle" style="margin-right:5px;"></i>' + json['error']+'</div>');
			}
		...
		if (json['success']) {
				$('.commnt-success').after('<div class="alert alert-success">' + json['success'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
				$('.success').fadeIn('slow');
