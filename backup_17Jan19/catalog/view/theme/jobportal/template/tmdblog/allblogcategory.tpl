		...
		<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
			<div class="product-layout product-list">
				<div class="product-thumb">
					...
					<?php if($tmdblogsetting_articleimg){ ?><div class="image listimg"><a href="<?php echo $allblogcat['href']; ?>"><img src="<?php echo $allblogcat['thumb']; ?>"  alt="<?php echo $allblogcat['name']; ?>" title="<?php echo $allblogcat['name']; ?>" class="img-responsive" /></a></div>
					<?php } ?>	
					...
					<div class="detail">
						<?php if($tmdblogsetting_descp){ ?><div class="description pull-left"><?php echo $allblogcat['description']; ?></div><?php } ?>
					</div>
					<br/><br/>
