  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?> login-form"><?php echo $content_top; ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
          <legend><?php echo $heading_your_details; ?></legend>
			...
			<div class="form-group">
				<div class="form-group required">
					<label class="col-sm-2 control-label" for="input-cvupload"><?php echo $label_resume; ?></label>
		...
		<div class="form-group">
          <label class="col-sm-1 control-label" ><?php echo $label_image; ?></label>
			<div class="imagebox col-sm-3">
	...
	<div class="form-group required">
        ...
        <fieldset id="address">
          <legend><?php echo $text_your_address; ?></legend>
			...
			<div class="form-group required">
				<label class="col-sm-12" for="input-about_self"><?php echo $label_about;?></label>
				<div class="col-sm-12">
					<input type="text" name="about_self" value="<?php echo $about_self; ?>" placeholder="<?php echo $entry_about;?>" id="input-about_self" class="form-control">
				</div>
			</div>
			<div class="form-group">
					...
					<table id="educations<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
						<thead>
							<tr>
								...
								<td class="text-left"><?php echo $label_button; ?></td>
							</tr>
						</thead>
						<tbody>
							<?php $education_row = 0; ?>
							<?php if (!empty($education_rowss[$language['language_id']])) { ?>
