    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-geo-zone" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-description"><?php echo $label_description; ?></label>
            <div class="col-sm-10">
          ...
          <table id="zone-to-geo-zone" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                <td class="text-left"><?php echo $label_country; ?></td>
                <td class="text-left"><?php echo $label_zone; ?></td>
                <td></td>
              </tr>
            </thead>
            <tbody>
