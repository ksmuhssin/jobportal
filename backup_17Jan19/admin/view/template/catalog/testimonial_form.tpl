    ...
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"  id="form-testimonial" class="form-horizontal">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-author"><?php echo $lable_author; ?></label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-country"><?php echo $lable_product; ?></label>
						<div class="col-sm-10">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-text"><?php echo $lable_text; ?></label>
						<div class="col-sm-10">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-name"><?php echo $lable_rating; ?></label>
						<div class="col-sm-10">
