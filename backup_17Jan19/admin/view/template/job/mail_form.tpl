				...
				<div class="tab-pane active" id="tab-mail">
					...
					<div class="tab-content">
						<div class="form-group required">
							<label class="col-sm-2 control-label" for="input-companytype"><?php echo $lable_type; ?></label>
							<div class="col-sm-10">
								<select name="companytype" class="form-control">
									<option value=""><?php echo $text_select?></option>
									<?php foreach ($companytypes as $result){ ?>
									<?php if ($companytype == $result['companytype']){ ?>
										<option value="<?php echo $result['companytype']; ?>" selected="selected"><?php echo $result['value']; ?></option> 
									<?php } else { ?>
										<option value="<?php echo $result['companytype']; ?>"><?php echo $result['value']; ?></option> 
									<?php } ?>
									<?php } ?>
								</select>	
							</div>
