		...
		<div class="panel-body">
			<div class="well">
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-name"><?php echo $filters_title; ?></label>
							<input type="text" name="filter_title" value="" placeholder="<?php echo $filters_title; ?>" id="input-name" class="form-control" />
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-package-title"><?php echo $filters_country;?> </label>
								<input type="text" name="filter_country" value="" placeholder="<?php echo $filters_country; ?>" id="input-name" class="form-control" />
								<input type="hidden" name="country_id" value="">
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-package-title"><?php echo $filters_zone; ?></label>
								<input type="text" name="filter_zone" value="" placeholder="<?php echo $filters_zone; ?>" id="input-name" class="form-control" />
								<input type="hidden" name="zone_id" value="">
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label class="col-sm-2 control-label" for="input-package-title"><?php echo $filters_company; ?></label>
								<input type="text" name="filter_company" value="" placeholder="<?php echo $filters_company; ?>" id="input-name" class="form-control" />
				...
				<div class="row">
					<!--<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-name"><?php echo $filters_category; ?></label>
								<input type="text" name="filter_category" value="" placeholder="<?php echo $filters_category; ?>" id="input-name" class="form-control" />
						</div>
					</div>-->
					<!--<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-name"><?php echo $filters_jobtype; ?></label>
					...
					<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-name"><?php echo $filters_meta_title; ?></label>
								<input type="text" name="filter_meta_title" value="" placeholder="<?php echo $filters_meta_title; ?>" id="input-name" class="form-control" />
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-name"><?php echo $filters_city; ?></label>
								<input type="text" name="filter_city" value="" placeholder="<?php echo $filters_city; ?>" id="input-name" class="form-control" />
						</div>
					</div>
...
$('#button-filter').on('click', function() {
	...
	var url = 'index.php?route=job/postjob&token=<?php echo $token; ?>';
	...
	/*var filter_jobtype = $('select[name=\'filter_jobtype\']').val();
...
$('input[name=\'filter_jobtype\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=job/jobtype/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					jobtype_id: 0,
