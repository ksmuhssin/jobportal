					...
					<thead>
						<tr>
							...
							<td class="text-left"><?php if ($sort == 'jobtype') { ?>
								<a href="<?php echo $sort_jobtype; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_jobtype; ?></a>
								<?php } else { ?>
								<a href="<?php echo $sort_jobtype; ?>"><?php echo $column_jobtype; ?></a>
								<?php } ?>
							</td>
							...
							<td class="text-left"><?php if ($sort == 'meta_description') { ?>
								<a href="<?php echo $sort_meta_description; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_description; ?></a>
								<?php } else { ?>
								<a href="<?php echo $sort_meta_description; ?>"><?php echo $column_description; ?></a>
								<?php } ?>
							</td>
						...
						<tr>
							<td class="text-center"><?php if (in_array($result['jobtype_id'], $selected)) { ?>
							<input type="checkbox" name="selected[]" value="<?php echo $result['jobtype_id']; ?>" checked="checked" />
							<?php } else { ?>
							<input type="checkbox" name="selected[]" value="<?php echo $result['jobtype_id']; ?>" />
							<?php } ?></td>
							
							<td class="text-left"><?php echo $result['jobtype']; ?></td>
							<td class="text-left"><?php echo $result['meta_title']; ?></td>
							<td class="text-left"><?php echo $result['meta_description']; ?></td>
