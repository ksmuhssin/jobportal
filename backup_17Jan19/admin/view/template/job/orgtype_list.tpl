					...
					<table class="table table-bordered table-hover">
						<thead>
							<tr>
								...
								<td class="text-left"><?php if ($sort == 'orgtype_name') { ?>
									<a href="<?php echo $sort_orgtype_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_orgtype_name; ?></a>
									<?php } else { ?>
									<a href="<?php echo $sort_orgtype_name; ?>"><?php echo $column_orgtype_name; ?></a>
									<?php } ?>
								</td>			
								...
								<td class="text-left"><?php echo $column_seo_keyword; ?></td>
						...
						<tr>
							<td class="text-center"><?php if (in_array($result['orgtype_id'], $selected)) { ?>
								<input type="checkbox" name="selected[]" value="<?php echo $result['orgtype_id']; ?>" checked="checked" />
								<?php } else { ?>
								<input type="checkbox" name="selected[]" value="<?php echo $result['orgtype_id']; ?>" />
								<?php } ?>
							</td>
							...
							<td class="text-left"><?php echo $result['orgtype_name']; ?></td>
