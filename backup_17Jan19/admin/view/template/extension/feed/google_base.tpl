      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-google-base" class="form-horizontal">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-data-feed"><?php echo $label_google_category; ?></label>
              <div class="col-sm-10">
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-data-feed"><?php echo $label_data_feed; ?></label>
              <div class="col-sm-10">
