        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-theme-default" class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-directory"><span data-toggle="tooltip" title="<?php echo $help_directory; ?>"><?php echo $label_directory; ?></span></label>
              <div class="col-sm-10">
          ...
          <fieldset>
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-catalog-limit"><span data-toggle="tooltip" title="<?php echo $help_product_limit; ?>"><?php echo $label_product_limit; ?></span></label>
              <div class="col-sm-10">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-description-limit"><span data-toggle="tooltip" title="<?php echo $help_product_description_length; ?>"><?php echo $label_product_description_length; ?></span></label>
              <div class="col-sm-10">
          ...
          <fieldset>
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-category-width"><?php echo $label_image_category; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-thumb-width"><?php echo $label_image_thumb; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-popup-width"><?php echo $label_image_popup; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-product-width"><?php echo $label_image_product; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-additional-width"><?php echo $label_image_additional; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-related"><?php echo $label_image_related; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-compare"><?php echo $label_image_compare; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-wishlist"><?php echo $label_image_wishlist; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-cart"><?php echo $label_image_cart; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
            ...
            <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-image-location"><?php echo $label_image_location; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
