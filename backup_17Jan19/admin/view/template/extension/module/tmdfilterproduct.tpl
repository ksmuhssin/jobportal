    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-tmdfilterproduct" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-name"><?php echo $label_moduletitle; ?></label>
            <div class="col-sm-10">
					...
					<div class="tab-pane active in" id="tab-module2">
						...
						<div class="tab-content">
							<div class="tab-pane active in" id="tab-recentpost">
							  ...
							  <div class="form-group">
									<label class="col-sm-2 control-label" for="input-recentposttitle"><?php echo $label_title; ?></label>
									<div class="col-sm-10">
							...
							<div class="tab-pane" id="tab-popular">
							  ...
							  <div class="form-group">
									<label class="col-sm-2 control-label" for="input-populartitle"><?php echo $label_title; ?></label>
									<div class="col-sm-10">
										<?php foreach ($languages as $language) { ?>
											<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> </span>
							...
							<div class="tab-pane" id="tab-comment">
							  ...
							  <div class="form-group">
									<label class="col-sm-2 control-label" for="input-commenttitle"><?php echo $label_title; ?></label>
									<div class="col-sm-10">
										<?php foreach ($languages as $language) { ?>
											<div class="input-group pull-left"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> </span>
