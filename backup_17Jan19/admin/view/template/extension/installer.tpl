      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="button-upload"><span data-toggle="tooltip" title="<?php echo $help_upload; ?>"><?php echo $label_upload; ?></span></label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $label_progress; ?></label>
            <div class="col-sm-10">
              <div class="progress">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo $label_overwrite; ?></label>
            <div class="col-sm-10">
