        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-megaheader" class="form-horizontal">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
				...
				<!--new code-->
				<div class="form-group">
					<label class="col-sm-2 control-label" for="input-mobilbtn-color"><span data-toggle="tooltip" title="<?php echo $help_menu; ?>"><?php echo $entry_mobilbtn; ?></span></label>
					<div class="col-sm-10">								
						<input type="text" name="megaheader_mobilbtn_color" value="<?php echo $megaheader_mobilbtn_color; ?>" placeholder="<?php echo $entry_mobilbtn; ?>" id="input-mobilbtn-color" class="form-control demo" />
					</div>							
				</div>
			
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-columnbg"><span data-toggle="tooltip" title="<?php echo $entry_columnbg; ?>"><?php echo $entry_columnbg; ?></span></label>
							<div class="col-sm-10">
							<input type="text" name="megaheader_columnbg" value="<?php echo $megaheader_columnbg; ?>" placeholder="<?php echo $entry_columnbg; ?>" id="input-columnbg" class="form-control demo" />
						</div>							
					</div>

				<div class="form-group">
					<label class="col-sm-2 control-label"><?php echo $text_labelbg;  ?></label>
					<div class="col-sm-10">
						<input type="text" name="megaheader_labelbg" value="<?php echo $megaheader_labelbg?>" placeholder="<?php echo $text_labelbg;  ?>" id="input-bg-color" class="form-control demo" />
					</div>
				</div>		
				
				<div class="form-group">
					<label class="col-sm-2 control-label"><?php echo $text_labeltext;  ?></label>
					<div class="col-sm-10">
						<input type="text" name="megaheader_labeltext" value="<?php echo $megaheader_labeltext?>" placeholder="<?php echo $text_labeltext;  ?>" id="input-bg-color" class="form-control demo" />
					</div>
				</div>
				<!--new code-->
			...
			<!-- update code -->
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-megaheader_menuexpend"><?php echo $entry_menuexpend; ?></label>
                <div class="col-sm-10">
                  <select name="megaheader_menuexpend" id="input-megaheader_menuexpend" class="form-control">
                    <?php if ($megaheader_menuexpend==1) { ?>
                    <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                    <option value="0"><?php echo $text_no; ?></option>
                    <?php } elseif($megaheader_menuexpend==0) { ?>
			...
			<!-- new code -->
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-megaheader_fontweight"><?php echo $entry_font; ?></label>
                <div class="col-sm-10">
                  <select name="megaheader_fontweight" id="input-megaheader_fontweight" class="form-control">
                    <?php if ($megaheader_fontweight==1) { ?>
                    <option value="1" selected="selected"><?php echo $text_bold; ?></option>
                    <option value="0"><?php echo $text_normal; ?></option>
                    <?php } elseif($megaheader_fontweight==0) { ?>
                    <option value="1"><?php echo $text_bold; ?></option>
                    <option value="0" selected="selected"><?php echo $text_normal; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-megaheader_fonttype"><?php echo $entry_texttype; ?></label>
                <div class="col-sm-10">
                  <select name="megaheader_fonttype" id="input-megaheader_fonttype" class="form-control">
                    <?php if ($megaheader_fonttype==1) { ?>
                    <option value="1" selected="selected"><?php echo $text_upper; ?></option>
                    <option value="0"><?php echo $text_lower; ?></option>
                    <?php } elseif($megaheader_fonttype==0) { ?>
                    <option value="1"><?php echo $text_upper; ?></option>
                    <option value="0" selected="selected"><?php echo $text_lower; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-megaheader_showproductcount"><?php echo $entry_showproductcount; ?></label>
                <div class="col-sm-10">
                  <select name="megaheader_showproductcount" id="input-megaheader_showproductcount" class="form-control">
                    <?php if ($megaheader_showproductcount==1) { ?>
                    <option value="1" selected="selected"><?php echo $text_yes; ?></option>
                    <option value="0"><?php echo $text_no; ?></option>
                    <?php } elseif($megaheader_showproductcount==0) { ?>
                    <option value="1"><?php echo $text_yes; ?></option>
                    <option value="0" selected="selected"><?php echo $text_no; ?></option>
                    <?php } ?>
                  </select>
