          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-customername"><?php echo $lable_customername; ?></label>
                <div class="col-sm-10">
                  <select name="employ_id" id="input-customername" class="form-control">
                    <option value=""><?php echo $text_select;?></option>
              			<?php foreach($employers as $employ) { ?>
              					<?php if ($employ_id == $employ['employ_id']) { ?>
              					<option value="<?php echo $employ['employ_id']?>" selected="selected"><?php echo $employ['fullname'];?></option>
              					<?php } else {?>
              					<option value="<?php echo $employ['employ_id']?>"><?php echo $employ['fullname'];?></option>
              				<?php } ?>
                    <?php } ?>
                  </select>
                </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-blogname"><?php echo $lable_tmdblog; ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $lable_comment; ?></label>
                <div class="col-sm-10">
