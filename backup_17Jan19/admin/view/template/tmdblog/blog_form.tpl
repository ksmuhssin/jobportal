        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				  ...
				  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $lable_tag; ?></label>
                    <div class="col-sm-10">
            ...
            <div class="tab-pane fade" id="tab-data">
			   ...
			   <div class="form-group">
                <label class="col-sm-2 control-label" for="input-status"><?php echo $lable_username; ?></label>
                <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-blogcategory"><span data-toggle="tooltip" title="<?php echo $help_tmdblogcategory; ?>"><?php echo $lable_tmdblogcategory; ?></span></label>
                <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $lable_blogcoment; ?></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane fade" id="tab-comment">
				...
				<table class="table table-bordered table-hover">
				 <thead>
					<tr>
					<td class="text-left"><?php echo $column_employ; ?></td>
				...
				<?php if($comments){?>
				 <?php foreach($comments as $comnt){?>
				  ...
				  <tr>
				  <td class="text-left"><?php echo $comnt['fullname']; ?></td>
