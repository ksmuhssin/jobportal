        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          ...
          <div class="tab-content col-sm-9">
            <div class="tab-pane active in" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-name<?php echo $language['language_id']; ?>"><?php echo $label_name; ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>"><?php echo $label_description; ?></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group required">
                    <label class="col-sm-2 control-label" for="input-meta-title<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_meta_title; ?>"><?php echo $label_meta_title; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-description<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_meta_description; ?>"><?php echo $label_meta_description; ?></span></label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_meta_keyword; ?>"><?php echo $label_meta_keyword; ?></span></label>
                    <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $label_image; ?></label>
			...
			<div class="tab-pane fade" id="tab-category">
				<div class="tab-pane active in" id="tab-postseting">
						<div class="form-group">
						<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_article; ?>"><?php echo $label_article; ?></span></label>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_descp; ?>"><?php echo $label_descp; ?></span></label>
							<div class="col-sm-9"><label class="radio-inline">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_feedbackrow; ?>"><?php echo $label_feedbackrow; ?></span></label>
							<div class="col-sm-9"><label class="radio-inline">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_facebook; ?>"><?php echo $label_facebook; ?></span></label>
							<div class="col-sm-9"><label class="radio-inline">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_twitter; ?>"><?php echo $label_twitter; ?></span></label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_pinterest; ?>"><?php echo $label_pinterest; ?></span></label>
							<div class="col-sm-9">
							  <label class="radio-inline">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_google; ?>"><?php echo $label_google; ?></span></label>
							<div class="col-sm-9">
							  <label class="radio-inline">
			...
			<div class="tab-pane fade" id="tab-blogpage">
				<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_articleimg; ?>"><?php echo $label_articleimg; ?></span></label>
							<div class="col-sm-9"><label class="radio-inline">
						...
						<div class="form-group">
						  <label class="col-sm-3 control-label"><span data-toggle="tooltip" title="<?php echo $help_blogcomment; ?>"><?php echo $label_blogcomments; ?></span></label>
						  <div class="col-sm-9">
							<label class="radio-inline">
						...
						<div class="form-group">
						  <label class="col-sm-3 control-label"><?php echo $label_commentlimit; ?></label>
						  <div class="col-sm-9">
					...
					<div class="form-group">
                <label class="col-sm-3 control-label" for="input-image-comntthumb"><?php echo $label_thumbimg; ?></label>
                <div class="col-sm-9">
                  <div class="row">
                    <div class="col-sm-6">
			  ...
			  <div class="form-group">
                <label class="col-sm-3 control-label" for="input-image-comntbanner"><?php echo $label_comntbanner; ?></label>
                <div class="col-sm-9">
                  <div class="row">
                    <div class="col-sm-6">
			...
			<div class="tab-pane fade" id="tab-color">
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-titletextcolor"><?php echo $label_titletextcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-blogtextcolor"><?php echo $label_blogtextcolor; ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="tmdblogsetting_headinghovercolor" value="<?php echo $tmdblogsetting_headinghovercolor; ?>"  id="input-blogtextcolor" class="form-control color" />
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-titlebgcolor"><?php echo $label_titlebgcolor; ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="tmdblogsetting_themecolor" value="<?php echo $tmdblogsetting_themecolor; ?>"  id="input-titlebgcolor" class="form-control color" />
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-themehovercolor"><?php echo $label_themehovercolor; ?></label>
                    <div class="col-sm-8">
                      <input type="text" name="tmdblogsetting_themehovercolor" value="<?php echo $tmdblogsetting_themehovercolor; ?>"  id="input-themehovercolor" class="form-control color" />
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-containerbgcolor"><?php echo $label_containerbgcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-postboxbgcolor"><?php echo $label_postboxbgcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-articletextcolor"><?php echo $label_articletextcolor; ?></label>
                    <div class="col-sm-8">
				...
				<div class="form-group">
                    <label class="col-sm-4 control-label" for="input-descptextcolor"><?php echo $label_descptextcolor; ?></label>
                    <div class="col-sm-8">
