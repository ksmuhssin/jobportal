...
// Label
$_['label_url']                    = 'Store URL';
$_['label_ssl']                    = 'SSL URL';
$_['label_meta_title']             = 'Meta Title';
$_['label_meta_description']       = 'Meta Tag Description';
$_['label_meta_keyword']           = 'Meta Tag Keywords';
$_['label_layout']                 = 'Default Layout';
$_['label_name']                   = 'Store Name';
$_['label_owner']                  = 'Store Owner';
$_['label_address']                = 'Address';
$_['label_geocode']                = 'Geocode';
$_['label_email']                  = 'E-Mail';
$_['label_telephone']              = 'Telephone';
$_['label_fax']                    = 'Fax';
$_['label_image']                  = 'Image';
$_['label_open']                   = 'Opening Times';
$_['label_location']               = 'Store Location';
$_['label_comment']                = 'Comment';
$_['label_country']                = 'Country';
$_['label_language']               = 'Language';
$_['label_zone']                   = 'Region / State';
$_['label_currency']               = 'Currency';
$_['label_tax']                    = 'Display Prices With Tax';
$_['label_tax_default']            = 'Use Store Tax Address';
$_['label_tax_customer']           = 'Use Customer Tax Address';
$_['label_customer_group']         = 'Customer Group';
$_['label_customer_group_display'] = 'Customer Groups';
$_['label_customer_price']         = 'Login Display Prices';
$_['label_account']                = 'Account Terms';
$_['label_cart_weight']            = 'Display Weight on Cart Page';
$_['label_checkout_guest']         = 'Guest Checkout';
$_['label_checkout']               = 'Checkout Terms';
$_['label_order_status']           = 'Order Status';
$_['label_stock_display']          = 'Display Stock';
$_['label_stock_checkout']         = 'Stock Checkout';
$_['label_logo']                   = 'Store Logo';
$_['label_secure']                 = 'Use SSL';
$_['label_icon']                   = 'Icon';
$_['label_theme']                   = 'Theme';
