...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getForm() {
		...
		$data['label_iso_code_2'] 		 = $this->language->get('label_iso_code_2');
		$data['label_iso_code_3'] 		 = $this->language->get('label_iso_code_3');
		$data['label_address_format']	 = $this->language->get('label_address_format');
		$data['label_postcode_required'] = $this->language->get('label_postcode_required');
		$data['label_postcode_required'] = $this->language->get('label_postcode_required');
