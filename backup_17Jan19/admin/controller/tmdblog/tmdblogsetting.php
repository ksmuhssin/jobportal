...
class ControllerTmdBlogTmdblogsetting extends Controller {
	...
	public function index() {
		...
		$data['label_parent'] 			= $this->language->get('label_parent');
		...
		$data['label_top'] 				= $this->language->get('label_top');
		$data['label_column'] 			= $this->language->get('label_column');
		$data['label_sort_order']		= $this->language->get('label_sort_order');
		$data['label_titlesize'] 		= $this->language->get('label_titlesize');
		$data['label_titlecolor'] 		= $this->language->get('label_titlecolor');
		$data['label_article'] 			= $this->language->get('label_article');
		$data['label_google'] 			= $this->language->get('label_google');
		$data['label_pinterest'] 		= $this->language->get('label_pinterest');
		$data['label_twitter'] 			= $this->language->get('label_twitter');
		$data['label_facebook'] 		= $this->language->get('label_facebook');
		$data['label_feedbackrow'] 		= $this->language->get('label_feedbackrow');
		$data['label_descp'] 			= $this->language->get('label_descp');
		$data['label_descptextcolor'] 	= $this->language->get('label_descptextcolor');
		$data['label_articletextcolor'] = $this->language->get('label_articletextcolor');
		$data['label_postboxbgcolor'] 	= $this->language->get('label_postboxbgcolor');
		$data['label_containerbgcolor'] = $this->language->get('label_containerbgcolor');
		$data['label_titlebgcolor'] 	= $this->language->get('label_titlebgcolor');
		$data['label_titletextcolor'] 	= $this->language->get('label_titletextcolor');
		$data['label_blogtextcolor'] 	= $this->language->get('label_blogtextcolor');
		$data['label_articleimg'] 		= $this->language->get('label_articleimg');
		$data['label_themehovercolor']  = $this->language->get('label_themehovercolor');
		$data['label_keyword'] 			= $this->language->get('label_keyword');
		$data['label_bloglayout'] 		= $this->language->get('label_bloglayout');
		$data['label_blogperpage'] 		= $this->language->get('label_blogperpage');
		$data['label_blogperrow']		= $this->language->get('label_blogperrow');
		$data['label_dispalytitle'] 	= $this->language->get('label_dispalytitle');
		$data['label_dispalydes'] 		= $this->language->get('label_dispalydes');
		$data['label_blogthumbsize'] 	= $this->language->get('label_blogthumbsize');
		$data['label_thumbimg'] 		= $this->language->get('label_thumbimg');
		$data['label_comntbanner']		= $this->language->get('label_comntbanner');
		$data['label_blogcomments'] 	= $this->language->get('label_blogcomments');
		$data['label_height'] 			= $this->language->get('label_height');
		$data['label_width'] 			= $this->language->get('label_width');
		$data['label_commentlimit'] 	= $this->language->get('label_commentlimit');
