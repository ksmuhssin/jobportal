...
class ControllerTmdBlogBlog extends Controller {
	...
	protected function getForm() {
		...
		$data['lable_username'] 	= $this->language->get('lable_username');
		$data['lable_tmdblogcategory'] = $this->language->get('lable_tmdblogcategory');
		...
		$data['lable_blogcoment'] 	= $this->language->get('lable_blogcoment');
		...
		$data['column_action'] 		= $this->language->get('column_action');
		$data['column_employ'] 		= $this->language->get('column_employ');
