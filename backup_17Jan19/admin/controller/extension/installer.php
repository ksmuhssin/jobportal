...
class ControllerExtensionInstaller extends Controller {
	public function index() {
		...
		$data['label_upload'] = $this->language->get('label_upload');
		$data['label_overwrite'] = $this->language->get('label_overwrite');
		$data['label_progress'] = $this->language->get('label_progress');
