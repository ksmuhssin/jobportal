...
class ControllerExtensionThemeThemeDefault extends Controller {
	...
	public function index() {
		...
		$data['label_product_description_length'] = $this->language->get('label_product_description_length');
		$data['label_status'] = $this->language->get('label_status');		
		$data['label_directory'] = $this->language->get('label_directory');
		$data['label_product_limit'] = $this->language->get('label_product_limit');
		$data['label_image_category'] = $this->language->get('label_image_category');
		$data['label_image_thumb'] = $this->language->get('label_image_thumb');
		$data['label_image_popup'] = $this->language->get('label_image_popup');
		$data['label_image_product'] = $this->language->get('label_image_product');
		$data['label_image_additional'] = $this->language->get('label_image_additional');
		$data['label_image_related'] = $this->language->get('label_image_related');
		$data['label_image_compare'] = $this->language->get('label_image_compare');
		$data['label_image_wishlist'] = $this->language->get('label_image_wishlist');
		$data['label_image_cart'] = $this->language->get('label_image_cart');
		$data['label_image_location'] = $this->language->get('label_image_location');
