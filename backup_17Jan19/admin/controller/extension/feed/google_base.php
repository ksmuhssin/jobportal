...
class ControllerExtensionFeedGoogleBase extends Controller {
	...
	public function index() {
		...
		$data['label_google_category'] = $this->language->get('label_google_category');
		$data['label_category'] = $this->language->get('label_category');
		$data['label_data_feed'] = $this->language->get('label_data_feed');
