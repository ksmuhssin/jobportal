...
class ControllerExtensionModuleTmdfilterProduct extends Controller {
	...
	public function index() {
		...
		$data['label_layouttype'] = $this->language->get('label_layouttype');
		$data['label_crousaltype'] = $this->language->get('label_crousaltype');
		...
		$data['label_title'] = $this->language->get('label_title');
		$data['label_moduletitle'] = $this->language->get('label_moduletitle');
