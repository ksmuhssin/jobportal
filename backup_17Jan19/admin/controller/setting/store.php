...
class ControllerSettingStore extends Controller {
	...
	protected function getForm() {
		...
		$data['label_ssl'] = $this->language->get('label_ssl');
		...
		$data['label_tax'] = $this->language->get('label_tax');
		$data['label_tax_default'] = $this->language->get('label_tax_default');
		$data['label_tax_customer'] = $this->language->get('label_tax_customer');
		$data['label_customer_group'] = $this->language->get('label_customer_group');
		$data['label_customer_group_display'] = $this->language->get('label_customer_group_display');
		$data['label_customer_price'] = $this->language->get('label_customer_price');
		$data['label_account'] = $this->language->get('label_account');
		$data['label_cart_weight'] = $this->language->get('label_cart_weight');
		$data['label_checkout_guest'] = $this->language->get('label_checkout_guest');
		$data['label_checkout'] = $this->language->get('label_checkout');
		$data['label_order_status'] = $this->language->get('label_order_status');
		$data['label_stock_checkout'] = $this->language->get('label_stock_checkout');
		$data['label_stock_display'] = $this->language->get('label_stock_display');
		$data['label_cart'] = $this->language->get('label_ajax_cart');
