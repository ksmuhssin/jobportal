...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['label_owner'] = $this->language->get('label_owner');
		$data['label_address'] = $this->language->get('label_address');
		$data['label_geocode'] = $this->language->get('label_geocode');
		$data['label_email'] = $this->language->get('label_email');
		$data['label_telephone'] = $this->language->get('label_telephone');
		$data['label_fax'] = $this->language->get('label_fax');
		$data['label_image'] = $this->language->get('label_image');
		$data['label_open'] = $this->language->get('label_open');
		$data['label_comment'] = $this->language->get('label_comment');
		$data['label_location'] = $this->language->get('label_location');
		$data['label_meta_title'] = $this->language->get('label_meta_title');
		$data['label_meta_description'] = $this->language->get('label_meta_description');
		$data['label_meta_keyword'] = $this->language->get('label_meta_keyword');
		$data['label_theme'] = $this->language->get('label_theme');
		...
		$data['label_language'] = $this->language->get('label_language');
		$data['label_admin_language'] = $this->language->get('label_admin_language');
		$data['label_currency'] = $this->language->get('label_currency');
		$data['label_currency_auto'] = $this->language->get('label_currency_auto');
		$data['label_length_class'] = $this->language->get('label_length_class');
		$data['label_weight_class'] = $this->language->get('label_weight_class');
		$data['label_limit_admin'] = $this->language->get('label_limit_admin');
		$data['label_joblisting_count'] = $this->language->get('label_joblisting_count');
		$data['label_captcha_page'] = $this->language->get('label_captcha_page');
		$data['label_captcha'] = $this->language->get('label_captcha');
		$data['label_logo'] = $this->language->get('label_logo');
		$data['label_icon'] = $this->language->get('label_icon');
		$data['label_ftp_hostname'] = $this->language->get('label_ftp_hostname');
		$data['label_ftp_port'] = $this->language->get('label_ftp_port');
		$data['label_ftp_username'] = $this->language->get('label_ftp_username');
		$data['label_ftp_password'] = $this->language->get('label_ftp_password');
		$data['label_ftp_root'] = $this->language->get('label_ftp_root');
		$data['label_ftp_status'] = $this->language->get('label_ftp_status');
		$data['label_mail_protocol'] = $this->language->get('label_mail_protocol');
		$data['label_mail_parameter'] = $this->language->get('label_mail_parameter');
		$data['label_mail_smtp_hostname'] = $this->language->get('label_mail_smtp_hostname');
		$data['label_mail_smtp_username'] = $this->language->get('label_mail_smtp_username');
		$data['label_mail_smtp_password'] = $this->language->get('label_mail_smtp_password');
		$data['label_mail_smtp_port'] = $this->language->get('label_mail_smtp_port');
		$data['label_mail_smtp_timeout'] = $this->language->get('label_mail_smtp_timeout');
		$data['label_mail_alert'] = $this->language->get('label_mail_alert');
		$data['label_mail_alert_email'] = $this->language->get('label_mail_alert_email');
		$data['label_alert_email'] = $this->language->get('label_alert_email');
		$data['label_secure'] = $this->language->get('label_secure');
		$data['label_shared'] = $this->language->get('label_shared');
		$data['labely_robots'] = $this->language->get('label_robots');
		$data['label_file_max_size'] = $this->language->get('label_file_max_size');
		$data['label_file_ext_allowed'] = $this->language->get('label_file_ext_allowed');
		$data['entrylabel_file_mime_allowed'] = $this->language->get('label_file_mime_allowed');
		$data['label_maintenance'] = $this->language->get('label_maintenance');
		$data['label_password'] = $this->language->get('label_password');
		$data['label_encryption'] = $this->language->get('label_encryption');
		$data['label_seo_url'] = $this->language->get('label_seo_url');
		$data['label_compression'] = $this->language->get('label_compression');
		$data['label_error_display'] = $this->language->get('label_error_display');
		$data['label_error_log'] = $this->language->get('label_error_log');
		$data['label_error_filename'] = $this->language->get('label_error_filename');
		...
		$data['entry_joblisting_count'] = $this->language->get('entry_joblisting_count');
		...
		if (isset($this->request->post['config_job_count'])) {
			$data['config_job_count'] = $this->request->post['config_job_count'];
		} else {
			$data['config_job_count'] = $this->config->get('config_job_count');
		}
