...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		$data['heading_title']			= $this->language->get('heading_title');
		//Tmd Blog
		$data['text_blog_right'] 		= $this->language->get('text_blog_right');
		...
		$data['text_column_candi'] 		= $this->language->get('text_column_candi');
		$data['text_column_blog'] 		= $this->language->get('text_column_blog');
		$data['text_column_feature']	= $this->language->get('text_column_feature');
		$data['text_column_testi'] 		= $this->language->get('text_column_testi');
		...
		$data['lable_route'] 			= $this->language->get('lable_route');
		$data['lable_module'] 			= $this->language->get('lable_module');
