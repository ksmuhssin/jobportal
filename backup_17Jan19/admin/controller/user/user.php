...
class ControllerUserUser extends Controller {
	...
	protected function getForm() {
		...
		$data['label_username'] = $this->language->get('label_username');
		$data['label_user_group'] = $this->language->get('label_user_group');
		$data['label_password'] = $this->language->get('label_password');
		$data['label_confirm'] = $this->language->get('label_confirm');
		$data['label_firstname'] = $this->language->get('label_firstname');
