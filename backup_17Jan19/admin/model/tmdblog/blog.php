...
class ModelTmdblogBlog extends Model {
	...
	public function getComments($blog_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "blogcomment b left join ". DB_PREFIX ."employ e on(b.employ_id = e.employ_id) where b.	blog_id = '". (int)$blog_id ."'");
	...
	public function getRecentBlogs() {
		...
		$query = $this->db->query("SELECT * FROM ".DB_PREFIX."blog b left join ".DB_PREFIX."blog_description bd on(b.blog_id = bd.blog_id) left join ".DB_PREFIX."blogcomment bc on(b.blog_id = bc.blog_id)  GROUP BY b.blog_id ORDER BY b.date_added DESC LIMIT 0,5");
